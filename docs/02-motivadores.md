...
[Ver tabla completa de restricciones técnicas](./02-motivadores/2.1-restricciones-tecnicas.md)
...
[Ver tabla completa de restricciones de negocio](./02-motivadores/2.2-restricciones-negocio.md)
...
[Ver detalles de atributos de calidad](./02-motivadores/2.3-atributos-calidad.md)

## 2.4 Funcionalidades críticas

Las funcionalidades críticas son las operaciones esenciales con restricciones funcionales.

[Ver lista completa de funcionalidades críticas](./02-motivadores/2.4-funcionalidades-criticas.md)